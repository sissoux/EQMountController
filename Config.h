...
// Slewing Speed: 1.79 degrees/second (estimated)
// Generated on: 2021-07-30 09:53
// ---------------------------------------------------------------------------------------------------------------------------------
...
#define PINMAP                        MyPCB //    OFF, Choose from: MiniPCB, MiniPCB2, MaxPCB, MaxPCB2, STM32Blue,             <-Req'd
...
#define SERIAL_C_BAUD_DEFAULT         115200 //    OFF, n, ON for ESP32 Bluetooth.                                               Option
...
#define SLEW_RATE_BASE_DESIRED        6 //    1.0, n. Desired slew rate in deg/sec. Adjustable at run-time from            <-Req'd
...
#define AXIS1_STEPS_PER_DEGREE    11520.0 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
#define AXIS1_STEPS_PER_WORMROT     14400 //  12800, n. Number of steps per worm rotation (PEC Eq mode only:)                <-Req'd
...
#define AXIS1_DRIVER_IGOTO            1100 //    OFF, n, (mA.) Current during slews. OFF uses same as IRUN.                    Option
...
#define AXIS1_DRIVER_INTPOL          true //   true, false to disable 256x interpolation.                                     Option
#define AXIS1_DRIVER_RSENSE          0.10 //   0.13, n, Rsense for TMC2130, Rsense for SSS TMC5160 is 0.075, can vary.        Adjust,*

// AXIS2 DEC/ALT
// see https://onstep.groups.io/g/main/wiki/6-Configuration#AXIS2
#define AXIS2_STEPS_PER_DEGREE    11520.0 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS2_DRIVER_IGOTO            1100 //    OFF, n, (mA.) Current during slews. OFF uses same as IRUN.                    Option
...
// Settings for TMC2130, TMC5160, etc? stepper drivers when in SPI mode.
#define AXIS2_DRIVER_INTPOL          true //   true, false to disable 256x interpolation.                                     Option
#define AXIS2_DRIVER_RSENSE          0.10 //   0.13, n, Rsense for TMC2130, Rsense for SSS TMC5160 is 0.075, can vary.        Adjust,*
...
#define FEATURE1_NAME          "INTERVALOMETER" // "FE..", Name of feature being controlled.                                        Adjust
#define FEATURE1_PURPOSE        INTERVALOMETER //    OFF, SWITCH, ANALOG_OUT, DEW_HEATER, INTERVALOMETER.                          Option
#define FEATURE1_TEMP                 OFF //    OFF, DS1820, n. Where n is the ds18b20 s/n for DEW_HEATER temperature.        Adjust
#define FEATURE1_PIN                  23  //    OFF, AUX, DS2413, n. Where n is ds2413 s/n (gpio0) or n=0 to 255 (pin#.)      Adjust
