...
/* This sample code demonstrates the basic use of a TinyGPSPlus object.
...
static void sendstring(TinyGPSPlus &gps, const PROGMEM char *str);
...
void setup()
{
  TinyGPSPlus test_gps;
  Serial.begin(115200);
  
  Serial.print("Testing TinyGPSPlus library v. "); Serial.println(TinyGPS::library_version());
